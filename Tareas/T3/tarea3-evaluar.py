...
class Evaluacion:
    def __init__(self, file_detecciones, file_gt):
        ...
        # seleccionar del ground-truth solo los archivos de television de las detecciones
        tv = set()
        for det in self.detecciones:
            tv.add(det.television)
        # filtrar gt relevante
        self.detecciones_gt = []
        for gt in groundtruth:
            if gt.television in tv:
...
def ejecutar_comandos(comerciales, television, work_dir):
    ...
    comandos = []
    # tareas en python
    comandos.append(["python", "tarea3-descriptores.py", television, descriptores_television])
    comandos.append(["python", "tarea3-descriptores.py", comerciales, descriptores_comerciales])
    comandos.append(["python", "tarea3-busqueda.py", descriptores_television, descriptores_comerciales, file_similares])
    comandos.append(["python", "tarea3-deteccion.py", file_similares, file_detecciones])
    # tareas en c++
    # comandos.append(["./tarea3-descriptores.py", television, descriptores_television])
    # comandos.append(["./tarea3-descriptores.py", comerciales, descriptores_comerciales])
    # comandos.append(["./tarea3-busqueda.py", descriptores_television, descriptores_comerciales, file_similares])
    # comandos.append(["./tarea3-deteccion.py", filename_similares, file_detecciones])
    # tareas en java
    # comandos.append(["java", "tarea3-descriptores.py", television, descriptores_television])
    # comandos.append(["java", "tarea3-descriptores.py", comerciales, descriptores_comerciales])
    # comandos.append(["java", "tarea3-busqueda.py", descriptores_television, descriptores_comerciales, file_similares])
    # comandos.append(["java", "tarea3-deteccion.py", file_similares, file_detecciones])
...
# inicio
if len(sys.argv) < 3:
    print("CC5213 - Evaluación Tarea 3  (2020-2)")
